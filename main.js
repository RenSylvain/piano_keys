...
----- here was provided at the beginning of the project, everything else is mine -----

// Write named functions that change the color of the keys below
let keyPlay = function (evt) {
    evt.target.style.backgroundColor = '#DDD';
}

// Write a named function with event handler properties
let keyReturn = function (evt) {
...
------ also this code below was provided -------
